      ...
      <AbonentDiv>   
        ...
        <fieldset className='Sett'>
            ...
            <div>
                ...
                <input type='radio' id='numb' value='number' onClick={(e)=>setTypeFilter(e.target.value)} name='src'/></div>
                <div><label htmlFor='name' >По имени</label>
                <input type='radio' id='name' value='name' onClick={(e)=>setTypeFilter(e.target.value)}  name='src'/></div>
                <div><label htmlFor="yu">По УИ</label>
                <input id='yu'type='radio' value='id' onClick={(e)=>setTypeFilter(e.target.value)}  name='src'/></div>
        </fieldset>
        </AbonentDiv>
        <fieldset>
